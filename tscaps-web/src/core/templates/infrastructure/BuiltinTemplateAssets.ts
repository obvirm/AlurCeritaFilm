...
// `BuiltinAssetCatalog`.
const cssModules = import.meta.glob('../../../../../../tscaps/templates/*/style.css', {
  eager: true,
  query: '?raw',
  import: 'default',
}) as Record<string, string>;

const configModules = import.meta.glob('../../../../../../tscaps/templates/*/template.json', {
  eager: true,
  import: 'default',
...
const filterModules = import.meta.glob('../../../../../../tscaps/templates/*/filters.svg', {
  eager: true,
  query: '?raw',
  import: 'default',
}) as Record<string, string>;
